...
-loop through th array starting at one 
-set a variable and set that to the index of the loop
-set another loop, as the variable is greater than 0 and is less than the value before, then swap
-return arr
 */
